...
The homeserver url is <https://matrix.agenticengineering.lat>
Access token is syt_ZmVybmFuZG8_JsBTwqNSmbEIeUQzURyk_3S2kNq
I dont know the room id but i know it will be present in the room url: <https://matrix.to/#/!cWijHjeTuafRWNndpL:matrix.agenticengineering.lat?via=matrix.agenticengineering.lat>
