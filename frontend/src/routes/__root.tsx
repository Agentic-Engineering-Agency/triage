...
import { MessageSquare, LayoutGrid, Settings, Sun, Moon, FolderGit2, LogOut, Plus, Trash2, Activity, Plug } from "lucide-react"
    ...
    <div className="flex h-screen w-screen overflow-hidden bg-background">
      ...
      <aside className="flex w-60 flex-col m-3 mr-0 rounded-2xl bg-card shadow-neu-raised">
        ...
        <nav className="flex flex-col gap-1.5 p-3 pt-4">
          ...
          <NavLink to="/project-settings" icon={<Plug className="h-4 w-4" />}>
            Integrations
          </NavLink>
