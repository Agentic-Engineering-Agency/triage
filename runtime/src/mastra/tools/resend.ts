  ...
  execute: async (input: any) => {
    ...
    try {
      const { data, error } = await resendClient.emails.send({
        ...
        html: renderTicketNotificationHtml(ctx),
        headers: {
  ...
  execute: async (input: any) => {
    ...
    try {
      ...
      const { data, error } = await resendClient.emails.send({
        ...
        html: renderResolutionNotificationHtml(ctx),
        headers: {
...
function renderTicketNotificationHtml(ctx: any): string {
...
function renderResolutionNotificationHtml(ctx: any): string {
